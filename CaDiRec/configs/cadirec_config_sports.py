...
def get_config():
    ...
    parser.add_argument("--dataset", default="sports", choices=['ml-1m', 'Beauty', 'sports', 'video'], help="Choose the dataset")
    ...
    parser.add_argument('--alpha', type=float, default=0.2, help='ratio of constrastive learning loss')
    parser.add_argument('--beta', type=float, default=0.14, help='ratio of diffusion nll loss')
