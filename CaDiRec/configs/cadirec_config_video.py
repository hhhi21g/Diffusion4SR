...
def get_config():
    ...
    parser.add_argument("--dataset", default="video", choices=['ml-1m', 'Beauty', 'Sports_and_Outdoors', 'video'], help="Choose the dataset")
    ...
    parser.add_argument('--alpha', type=float, default=0.18, help='ratio of constrastive learning loss')
    parser.add_argument('--beta', type=float, default=0.12, help='ratio of diffusion nll loss')
    parser.add_argument('--gamma', type=float, default=0.0, help='ratio of diffusion mse loss')
    parser.add_argument('--mlm_probability_train', type=float, default=0.12, help='mlm_probability for train')
    parser.add_argument('--mlm_probability', type=float, default=0.12, help='mlm_probability')
